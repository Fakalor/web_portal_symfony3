 ...
 */
final class Version20190627220556 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, role_id INT NOT NULL, login VARCHAR(45) NOT NULL, email VARCHAR(45) NOT NULL, password VARCHAR(255) NOT NULL, warning INT NOT NULL, ban TINYINT(1) NOT NULL, INDEX IDX_1483A5E9D60322AC (role_id), UNIQUE INDEX email_idx (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, product_category_id INT NOT NULL, user_id INT NOT NULL, product_name VARCHAR(45) NOT NULL, description TEXT NOT NULL, INDEX IDX_B3BA5A5ABE6903FD (product_category_id), INDEX IDX_B3BA5A5AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE deals (id INT AUTO_INCREMENT NOT NULL, auction_id INT NOT NULL, user_id INT NOT NULL, price DOUBLE PRECISION NOT NULL, date DATETIME NOT NULL, INDEX IDX_EF39849B57B8F0DE (auction_id), INDEX IDX_EF39849BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE auctions (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, start_price DOUBLE PRECISION DEFAULT NULL, description TEXT DEFAULT NULL, INDEX IDX_72D6E9004584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
